        ...
        <div >
            ...
            <div className=" py-10">
                <div className='container mx-auto flex  flex-col md:flex-row justify-between items-center'>
                    <div className='w-1/2'><p>"I couldn't be happier with the exceptional service and high-quality automobiles from roadbeast. From the moment I stepped into their showroom, I knew I was in the right place. Their knowledgeable and friendly staff helped me find the perfect vehicle that matched my needs and preferences.
